...
class BTechTenantTokens {
  ...
  static const BTechTenantTokens defaultTokens = BTechTenantTokens(
    ...
    primaryBorder: const Color(0xFF166534),
    secondaryBg: const Color(0xFFF3F4F6),
    secondaryBgHover: const Color(0xFFE5E7EB),
    secondaryFg: const Color(0xFF1F2937),
    secondaryBorder: const Color(0xFFD1D5DB),
    dangerBg: const Color(0xFFB91C1C),
    dangerFg: const Color(0xFFFFFFFF),
    surfaceDefault: const Color(0xFFFFFFFF),
