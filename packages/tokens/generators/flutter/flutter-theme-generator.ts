...
// emits 5 Dart files under platforms/flutter/token/lib/src/.
...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  console.log('[flutter-theme-generator] Generated 5 Dart files under platforms/flutter/token/lib/src/');
}
