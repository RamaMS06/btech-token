...
const BTechColorTheme _btechColorDark = BTechColorTheme(
  ...
  brand: BTechColorBrand(
    primarySubtle: Color(0xFF08244E),
    primary: Color(0xFF437CCF),
    primaryBold: Color(0xFF145BC3),
    secondarySubtle: Color(0xFF5A3D0B),
    secondary: Color(0xFFE8BA6C),
    secondaryBold: Color(0xFFF59E0B),
  ),
  ext: BTechColorExt(
