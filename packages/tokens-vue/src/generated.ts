...
export const ColorPrimaryBg = "#15803d"; // Main brand background — overridable per tenant. Uses .700 to ensure WCAG AA with white text.
export const ColorPrimaryBgHover = "#166534";
export const ColorPrimaryFg = "#ffffff";
export const ColorPrimaryBorder = "#166534";
export const ColorSecondaryBg = "#f3f4f6";
export const ColorSecondaryBgHover = "#e5e7eb";
export const ColorSecondaryFg = "#1f2937";
export const ColorSecondaryBorder = "#d1d5db";
export const ColorDangerBg = "#b91c1c";
export const ColorDangerBgHover = "#b91c1c";
export const ColorDangerFg = "#ffffff";
export const ColorDangerBorder = "#b91c1c";
export const ColorSuccessBg = "#22c55e";
export const ColorSuccessFg = "#ffffff";
export const ColorWarningBg = "#f97316";
export const ColorWarningFg = "#ffffff";
export const ColorSurfaceDefault = "#ffffff";
export const ColorSurfaceSubtle = "#f9fafb";
export const ColorSurfaceRaised = "#f3f4f6";
export const ColorTextDefault = "#111827";
export const ColorTextSubtle = "#6b7280";
...
export const ButtonSizeSmPaddingX = "12px";
...
export const ButtonSizeLgPaddingY = "12px";
