 ...
 * optional leading/trailing icon render props.
 */
...
const ICONS = [LIST_ICON, GRID_ICON, MAP_ICON];
  ...
  return (
    <section className="showcase-section">
      ...
      <p className="showcase-section__subtitle">
        ...
        Controlled via activeIndex + onActiveIndexChange.
      </p>
      ...
      <div className="showcase-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 12 }}>
        ...
        <BTTabs
          variant="segmented"
          tabs={BASIC_TABS}
          activeIndex={segActive}
          onActiveIndexChange={setSegActive}
        />
      ...
      <div className="showcase-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 12, marginTop: 24 }}>
        ...
        <BTTabs
          variant="line"
          tabs={BASIC_TABS}
          activeIndex={lineActive}
          onActiveIndexChange={setLineActive}
        />
      ...
      <div className="showcase-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 12, marginTop: 24 }}>
        ...
        <BTTabs
          ...
          onActiveIndexChange={setDisabledActive}
        />
        <BTTabs
          variant="line"
          tabs={DISABLED_TABS}
